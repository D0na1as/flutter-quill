...
class FlutterQuillLocalizationsEn extends FlutterQuillLocalizations {
  FlutterQuillLocalizationsEn([String locale = 'lt']) : super(locale);
...
/// The translations for English, as used in the Lithuania (`lt`).
class FlutterQuillLocalizationsEnUs extends FlutterQuillLocalizationsEn {
  FlutterQuillLocalizationsEnUs() : super('LT');
